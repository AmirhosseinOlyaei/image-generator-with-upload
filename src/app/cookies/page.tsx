      ...
      <Container component="main" sx={{ flexGrow: 1, py: 8 }}>
        <Paper sx={{ p: 4, borderRadius: 2 }}>
          ...
          <Typography variant="body1" paragraph>
            This Cookie Policy explains how Ghibli Vision ("we", "our", or "us") uses cookies and similar technologies to recognize you when you visit our website. It explains what these technologies are and why we use them, as well as your rights to control our use of them.
          </Typography>
          ...
          <Typography variant="body1" paragraph>
            Cookies set by the website owner (in this case, Ghibli Vision) are called "first-party cookies". Cookies set by parties other than the website owner are called "third-party cookies". Third-party cookies enable third-party features or functionality to be provided on or through the website (e.g., advertising, interactive content, and analytics).
          </Typography>
          ...
          <Typography variant="body1" paragraph>
            These cookies are strictly necessary to provide you with services available through our website and to use some of its features, such as access to secure areas. Without these cookies, services you have asked for cannot be provided.
          </Typography>
          ...
          <Typography variant="body1" paragraph>
            If you have any questions about our use of cookies or other technologies, please email us at privacy@ghiblivision.com.
          </Typography>
        </Paper>
      </Container>
