      ...
      >
        ...
        <DialogContent>
          <Typography variant="body1" paragraph>
            Unlock unlimited Ghibli-style transformations with one of our subscription plans.
            Choose the plan that suits your needs and start transforming your photos today.
          </Typography>
              ...
              <Grid item xs={12} md={4} key={plan.id}>
                <Paper 
                  ...
                  sx={{ 
                    ...
                    borderColor: selectedPlan === plan.id ? `${plan.color}.main` : 'transparent',
                    borderWidth: 2,
                    borderStyle: 'solid',
                    '&:hover': {
                ...
                >
                  ...
                  <Typography variant="h5" component="h3" gutterBottom sx={{ fontWeight: 'bold', color: `${plan.color}.main` }}>
                    {plan.name}
                  </Typography>
                    ...
                    {plan.features.map((feature, index) => (
                      <ListItem key={index} disableGutters sx={{ py: 0.5 }}>
                        <ListItemIcon sx={{ minWidth: 32 }}>
                          <CheckCircleIcon color={plan.color as any} fontSize="small" />
                        </ListItemIcon>
                        <ListItemText 
                          primary={feature} 
