...
export default function MainAppBar({ user, loading }: MainAppBarProps) {
        ...
        {!loading && !user && (
          <>
            <ListItem disablePadding>
              <ListItemButton sx={{ textAlign: 'center' }} component={Link} href="/auth/signin">
  ...
  return (
    <>
      <AppBar position="fixed" color="default" elevation={0} sx={{ bgcolor: 'rgba(255, 255, 255, 0.9)', backdropFilter: 'blur(10px)' }}>
